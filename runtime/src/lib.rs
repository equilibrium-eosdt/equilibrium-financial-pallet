...
impl manual_timestamp::Config for Runtime {
    type Event = Event;
}

/// Configure the pallet portfolio in pallets/portfolio.
impl portfolio::Config for Runtime {
    type Event = Event;
    type Asset = Asset;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        Financial: financial_pallet::{Pallet, Call, Storage, Event<T>, Config<T>},
        Oracle: oracle::{Pallet, Call, Storage, Event<T>, Config<T>},
        ManualTimestamp: manual_timestamp::{Pallet, Call, Storage, Event<T>, Config},
        Portfolio: portfolio::{Pallet, Call, Storage, Event<T>},
    }
);
